        ...
        >
            ...
            {dialogue && (
                <motion.div
                    ...
                    className="absolute -top-16 -right-10 z-20 max-w-[200px]"
                >
                    <div className="relative bg-white text-black p-3 rounded-2xl border-4 border-black shadow-[4px_4px_0px_0px_rgba(168,85,247,1)]">
                        ...
                        {/* Bubble Tail */}
                        <div className="absolute -bottom-3 left-4 w-4 h-4 bg-white border-b-4 border-r-4 border-black rotate-45 transform" />
                    </div>
                </motion.div>
            )}
